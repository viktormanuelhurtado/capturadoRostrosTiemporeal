...
if not os.path.exists('Rostros encontrados'):
    print('Carpeta creada: Rostro encontrados')
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        if k==ord('s'):
            ...
            cv2.imwrite('Rostros encontrados.png',frame)
            cv2.imshow('rostro',rostro)
            count=count +1 
    
    cv2.rectangle(frame,(10,5),(450,25),(255,255,255),-1)
    cv2.putText(frame,'Presione s,para almacenar los rostros encontrados',(10,20), 2, 0.5,(128,0,255),2)
